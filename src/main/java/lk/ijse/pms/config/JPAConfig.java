...
@EnableJpaRepositories(basePackageClasses = {TechLeadRepo.class})
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource ds, JpaVendorAdapter jpa){
        ...
        bean.setPackagesToScan("lk.ijse.pms.entity");
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl("jdbc:mysql://localhost/pms?createDatabaseIfNotExist=true");
        ds.setUsername("root");
